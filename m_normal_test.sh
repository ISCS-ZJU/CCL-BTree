...
CWARMING="-w"
# CDEBUG="-DNDEBUG" 
CXXFLAG="-lpmem -lpmemobj -lpthread -march=native"
...
g++ -I include/multiThread/dptree/include -I include $definesdp -DDPTREE -O3 $CDEBUG $CWARMING -o mybin/m_normal_test_dptree test/multiThread/normal_test.cpp $CPPPATH_DPTREE $CPPPATH $CXXFLAG $CPPLINK 
wait
for num_threads in ${threads[@]} 
do
for ssize in ${scansize[@]}
